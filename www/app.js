...
components: [ {
name: "r_reset",
content: "\u00bfReiniciar acertadas?",
style: "margin-bottom: 14px;font-size: 120%"
}, {
layoutKind: "FittableColumnsLayout",
components: [ {
name: "b_si",
...
name: "b_marcas2fich",
kind: "onyx.Button",
content: "Fichero con marcadas",
style: "width: 100%; height: 1.2cm",
classes: "onyx-blue",
ontap: "fb_marcas2fich"
}, {
name: "b_borrar_marcadas",
kind: "onyx.Button",
content: "Borrar marcadas",
style: "width: 100%; height: 1.2cm",
classes: "onyx-negative",
ontap: "fb_borrar_marcadas"
} ]
}, {
name: "p_todas",
kind: "onyx.Popup",
floating: !0,
style: "border-width: thick; border-style: double",
centered: "true",
modal: !0,
autoDismiss: !0,
components: [ {
...
fb_quitar_marcas: function() {
this.$.marcadas.hide(), this.$.b_todas.setContent(m3[this.x_idioma][4]), this.$.p_todas.show();
},
fb_todas: function() {
this.$.p_todas.hide(), this.$.b_todas.getContent() == "Quitar todas las marcas" ? marcas.length = 0 : borrar_marcadas();
},
fb_marcas2fich: function() {
this.$.marcadas.hide(), this.$.i_nom_fich.setValue(""), this.$.b_grabar.setDisabled(!0), this.$.p_nom_fichero.show();
},
habilitar_grabar: function() {
this.$.b_grabar.setDisabled(!1);
},
fb_borrar_marcadas: function() {
this.$.marcadas.hide(), this.$.b_todas.setContent(m4[this.x_idioma][1]), this.$.p_todas.show();
},
fb_grabar: function() {
...
create: function() {
this.inherited(arguments), W < 241 && (this.$.b_correcto.setStyle("padding-left: 6px; padding-right: 6px; background-color: green"), this.$.b_error.setStyle("padding-left: 10px; padding-right: 10px; background-color: red"), this.$.b_marcar.setStyle("padding-left: 6px; padding-right: 6px; background-color: blue"));
},
x_idiomaChanged: function() {
this.$.b_respuesta.setContent(m4[this.x_idioma][3]), this.$.b_volver.setContent(m4[this.x_idioma][2]), this.$.b_correcto.setContent(m1[this.x_idioma][7]), this.$.b_error.setContent(m1[this.x_idioma][6]), this.$.r_reset.setContent(m2[this.x_idioma][4]), this.$.b_si.setContent(m1[this.x_idioma][0]), this.$.b_no.setContent(m1[this.x_idioma][6]);
},
nom_listaChanged: function() {
this.$.t_nom_lista.setContent(this.nom_lista);
},
estadisticasChanged: function() {
...
fb_respuesta: function() {
this.$.t_respuesta.setContent(this.respuesta), this.$.b_respuesta.setFit(!1), this.$.b_respuesta.hide(), this.$.b_volver.hide(), this.$.b_correcto.show(), this.$.b_error.show(), this.$.b_marcar.show(), this.$.b_correcto.setFit(!0), this.$.b_marcar.setContent(marcada ? m4[this.x_idioma][5] : m4[this.x_idioma][4]), this.$.botones.reflow();
},
fb_volver: function() {
miTest.setIndex(0);
},
...
components: [ {
name: "r_preg_tam",
content: "Tama\u00f1o de letra",
style: "line-height: 205%"
}, {
content: "%",
fit: !0,
style: "line-height: 204%; text-align: right"
}, {
kind: "onyx.PickerDecorator",
components: [ {
style: "width: 65px"
...
fp_pc_rgb: function(e, t) {
switch (e.name) {
case "p_pc_r":
this.nuevas_prefs[P_TXT_R] = t.content;
break;
case "p_pc_g":
this.nuevas_prefs[P_TXT_G] = t.content;
break;
case "p_pc_b":
this.nuevas_prefs[P_TXT_B] = t.content;
}
this.$.row_preg.setStyle("color: rgb(" + this.nuevas_prefs[P_TXT_R] + "," + this.nuevas_prefs[P_TXT_G] + "," + this.nuevas_prefs[P_TXT_B] + "); background-color: rgb(" + this.nuevas_prefs[P_FON_R] + "," + this.nuevas_prefs[P_FON_G] + "," + this.nuevas_prefs[P_FON_B] + ");");
},
fp_pf_rgb: function(e, t) {
switch (e.name) {
case "p_pf_r":
this.nuevas_prefs[P_FON_R] = t.content;
break;
case "p_pf_g":
this.nuevas_prefs[P_FON_G] = t.content;
break;
case "p_pf_b":
this.nuevas_prefs[P_FON_B] = t.content;
}
this.$.row_preg.setStyle("color: rgb(" + this.nuevas_prefs[P_TXT_R] + "," + this.nuevas_prefs[P_TXT_G] + "," + this.nuevas_prefs[P_TXT_B] + "); background-color: rgb(" + this.nuevas_prefs[P_FON_R] + "," + this.nuevas_prefs[P_FON_G] + "," + this.nuevas_prefs[P_FON_B] + ");");
},
fp_resp_tam: function(e, t) {
this.nuevas_prefs[R_TXT_TAM] = t.content;
},
fp_rc_rgb: function(e, t) {
switch (e.name) {
case "p_rc_r":
this.nuevas_prefs[R_TXT_R] = t.content;
break;
case "p_rc_g":
this.nuevas_prefs[R_TXT_G] = t.content;
break;
case "p_rc_b":
this.nuevas_prefs[R_TXT_B] = t.content;
}
...
fp_rf_rgb: function(e, t) {
switch (e.name) {
case "p_rf_r":
this.nuevas_prefs[R_FON_R] = t.content;
break;
case "p_rf_g":
this.nuevas_prefs[R_FON_G] = t.content;
break;
case "p_rf_b":
this.nuevas_prefs[R_FON_B] = t.content;
}
this.$.row_resp.setStyle("color: rgb(" + this.nuevas_prefs[R_TXT_R] + "," + this.nuevas_prefs[R_TXT_G] + "," + this.nuevas_prefs[R_TXT_B] + "); background-color: rgb(" + this.nuevas_prefs[R_FON_R] + "," + this.nuevas_prefs[R_FON_G] + "," + this.nuevas_prefs[R_FON_B] + ");");
},
fb_aplicar: function() {
...
milog("fbResetear"), acertadas = 0, control = new Array;
for (var t = 0; t < numero_preguntas; t++) control.push(t * 2);
num_pregs_control = numero_preguntas, e && (e = new Array), miTest.$.principal.setEstadisticas(acertadas + "/" + numero_preguntas), miTest.$.preg_resp.setEstadisticas(""), miTest.$.preg_resp.setEstadisticas(acertadas + "/" + numero_preguntas), carga_pregunta();
}
...
var t;
for (t = 0; t < marcas.length; t++) if (marcas[t] == e) break;
marcas = marcas.slice(0, t).concat(marcas.slice(t + 1, marcas.length));
}

function valor_css(e, t) {
var n = e.replace(/ /g, "").split(";");
for (p in n) if (n[p].split(":")[0] == t) return n[p].split(":")[1];
}
...
function d_preferencias() {
prefs_default(), d_carga_lista_inicial(), miTest.setX_idioma(prefs[IDIOMA]), miTest.$.preg_resp.setX_actualizar(Math.random());
}
...
function d_carga_lista_inicial() {
nombre = "Test", lista = [ "pregunta-1", "repuesta-1", "pregunta<br />2", "repuesta-2", "pregunta 3<ul><li>uno</li><li>dos</li><li>tres</li></ul>", "repuesta-3<ul><li>dos</li></ul>", "pregunta-4", "repuesta-4", "pregunta-5", "repuesta-5", "pregunta-5", "repuesta-5", "pregunta-5", "repuesta-5", "pregunta-5", "repuesta-5", "pregunta-5", "repuesta-5", "pregunta-5", "repuesta-5", "pregunta-5", "repuesta-5", "pregunta-5", "repuesta-5", "pregunta-6", "repuesta-6" ], miTest.$.principal.setLis_actual(nombre), miTest.$.preg_resp.setNom_lista(nombre), numero_preguntas = (lista.length - lista.length % 2) / 2, fbReseteo();
}
